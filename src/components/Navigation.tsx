      ...
      >
        <div className="max-w-7xl mx-auto px-8 lg:px-16 flex items-center justify-between">
          ...
          <a
            ...
            className="text-xl font-medium text-white hover:text-white/80 transition-colors duration-300 tracking-wider"
          >
          ...
          <div className="hidden lg:flex items-center gap-10">
            {navigationConfig.items.map((item) => (
              <a
                ...
                className="text-body-sm text-white/60 hover:text-white transition-colors duration-300 relative group tracking-wide"
              >
                {item.label}
        ...
        <div className="flex flex-col items-center justify-center h-full gap-8">
          {navigationConfig.items.map((item, i) => (
            <a
              ...
              href={item.href}
              onClick={(e) => handleNavClick(e, item.href)}
              className="text-h3 text-white hover:text-white/70 transition-colors duration-300"
              style={{
